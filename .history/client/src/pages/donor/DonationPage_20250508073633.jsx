...
import { useParams } from "react-router-dom"; // Added useParams for extracting donorId and charityId
...
const DonationPage = () => {
  ...
  const { donorId, charityId } = useParams(); // Extract donorId and charityId from URL
