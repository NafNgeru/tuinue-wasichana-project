...
import "../../styles/HomePage.css"; // Make sure to update this CSS file
import HeroImage from "../../assets/hero.jpg"; // Replace with your actual image path
import ImpactIcon1 from "client/src/assets/impact1.svg"; // Replace with your actual icon paths
import ImpactIcon2 from "../../assets/impact2.svg";
import ImpactIcon3 from "../../assets/impact3.svg";
import EmpowermentImage from "../../assets/empowerment.jpg"; // Replace with your actual image path
              ...
              <div className="w-12 h-12 mx-auto mb-3">
                ...
                >
                  <path
                    ...
                    strokeWidth="2"
                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.523 5.754 18 7.5 18s3.332.523 4.5 1.247m0-13c1.168-.77 2.754-1.247 4.5-1.247s3.332.477 4.5 1.247v13c-1.168-.77-2.754-1.247-4.5-1.247s-3.332.477-4.5 1.247V6.253z"
                  />
                </svg>
              </div>
              ...
              <div className="w-12 h-12 mx-auto mb-3">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M9 12h6m-6 4h6m2-2H9m-2 4h2m2-2h2"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">
