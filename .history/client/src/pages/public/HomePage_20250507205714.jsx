...
//import "./HomePage.css";
import HeroImage from "./client/src/assets/hero.jpg";
import ImpactIcon1 from "./client/src/assets/impact1.svg";
import ImpactIcon2 from "./client/src/assets/impact2.svg";
import ImpactIcon3 from "./client/src/assets/impact3.svg";
import EmpowermentImage from "./client/src/assets/empowerment.jpg";
  ...
  return (
    <main className="font-sans bg-gray-50 text-gray-900">
      ...
      <section className="relative text-center py-16 bg-blue-50">
        <div className="container mx-auto rounded-xl overflow-hidden shadow-xl border-4 border-white">
          <img
            src={HeroImage}
            alt="Vibrant banner showcasing the spirit of empowerment"
            className="w-full h-[400px] object-cover brightness-75 rounded-xl"
          />
        </div>
