      ...
      >
        ...
        <nav
          style={{
            ...
            display: "flex",
            alignItems: "center",
            marginRight: "10rem", // Add a right margin to the navigation container
          }}
        >
          <a
            href="/"
            className="hover:text-blue-500 transition duration-300" // Removed text-gray-600
            style={{ marginRight: "1rem", fontSize: "1.5rem", color: "black" }} // Added black color
          >
            Home
          </a>
          <a
            href="/about"
            className="hover:text-blue-500 transition duration-300" // Removed text-gray-600
            style={{ marginRight: "1rem", fontSize: "1.2rem", color: "black" }} // Added black color
          >
            About
          </a>
          <a
            href="/stories"
            className="hover:text-blue-500 transition duration-300" // Removed text-gray-600
            style={{ fontSize: "1.2rem", color: "black", marginRight: "1rem" }} // Added black color
          >
            Stories
          </a>
          <a
            ...
            className="hover:text-blue-500 transition duration-300" // Removed text-gray-600
            style={{ fontSize: "1.2rem", color: "black" }} // Added black color
          >
            Charities
          </a>
        </nav>
