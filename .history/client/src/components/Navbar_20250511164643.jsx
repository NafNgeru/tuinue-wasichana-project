...
const Navbar = () => {
  return (
    <header
      ...
      style={{ height: "140px" }} // Adjusted header height to accommodate larger images
    >
      <div
        className="mx-auto flex items-center justify-between px-4" // Removed 'container' class
        style={{ height: "100%", marginLeft: "2" }} // Container moved to the left
      >
        <div className="flex items-center">
          ...
          <img
            ...
            style={{ height: "100px", width: "100px", marginRight: "2rem" }} // Increased height and width
          />
          <div className="flex flex-col items-center -mt-4">
            <h1
              className="text-xl font-bold text-gray-800"
              style={{ fontSize: "2rem", marginBottom: "0rem" }}
            >
              Tuinue Wasichana
            </h1>
