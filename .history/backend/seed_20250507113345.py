...
charity_data = [
    {
        ...
        "password": "pass1234",  # Password for seeding
...
with app.app_context():
    ...
    for item in charity_data:
        ...
        # Ensure charities have a valid password hash (even if not used for login)
        charity = Charity(
            user_id=user.id,
            ...
            password_hash=hashed_pw  # Provide a password hash here for the charity (if required)
        )
